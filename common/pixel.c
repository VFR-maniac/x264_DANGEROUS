...
#if HIGH_BIT_DEPTH
#if HAVE_MMX
PIXEL_NSSD7( _mmxext, _mmxext, )
PIXEL_NSSD5( _sse2, _sse2, )
#endif
#else
#if HAVE_MMX
PIXEL_NSSD7( _mmx, _mmx, )
PIXEL_NSSD5( _mmxext, _mmx, _mmxext )
PIXEL_NSSD2( _mmxext, _mmx, )
PIXEL_NSSD5( _sse2slow, _sse2slow, _mmxext )
PIXEL_NSSD5( _sse2, _sse2, _mmxext )
PIXEL_NSSD5( _ssse3, _ssse3, _mmxext )
PIXEL_NSSD2( _ssse3, _ssse3, )
PIXEL_NSSD5( _avx, _avx, _mmxext )
#endif
#if HAVE_ARMV6

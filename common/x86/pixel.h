...
DECL_X4( sad, sse3 )
DECL_X4( sad, ssse3 )
DECL_PIXELS( int, ssd, mmx, ( pixel *, intptr_t, pixel *, intptr_t, int ) )
DECL_PIXELS( int, ssd, mmx2, ( pixel *, intptr_t, pixel *, intptr_t, int ) )
DECL_PIXELS( int, ssd, sse2slow, ( pixel *, intptr_t, pixel *, intptr_t, int ) )
DECL_PIXELS( int, ssd, sse2, ( pixel *, intptr_t, pixel *, intptr_t, int ) )
DECL_PIXELS( int, ssd, ssse3, ( pixel *, intptr_t, pixel *, intptr_t, int ) )
DECL_PIXELS( int, ssd, avx, ( pixel *, intptr_t, pixel *, intptr_t, int ) )
DECL_PIXELS( int, ssd, xop, ( pixel *, intptr_t, pixel *, intptr_t, int ) )
